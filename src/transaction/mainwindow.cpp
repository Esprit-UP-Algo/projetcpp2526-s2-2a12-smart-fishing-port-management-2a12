...
#include "ui_transaction_mainwindow.h"
...
MainWindow::MainWindow(QWidget *parent)
    : QMainWindow(parent)
    , ui(new Ui::TransactionMainWindow)
{
    ui->setupUi(this);
    ...
    auto sidebarButtons = {ui->sideBtn0, ui->sideBtn1, ui->sideBtn2,
...
void MainWindow::setSidebarActiveVentes()
{
    setActiveSidebarButton(ui->sideBtn5);
}
...
void MainWindow::setActiveSidebarButton(QPushButton *activeBtn)
{
    ...
    for (auto *btn : {ui->sideBtn0, ui->sideBtn1, ui->sideBtn2,
                      ui->sideBtn3, ui->sideBtn4, ui->sideBtn5}) {
