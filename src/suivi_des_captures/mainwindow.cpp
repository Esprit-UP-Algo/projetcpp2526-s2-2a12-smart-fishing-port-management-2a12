    ...
    : QMainWindow(parent)
{
    ...
    setSidebarActiveCaptures();
}

void MainWindow::setSidebarActiveCaptures()
{
    if (m_sidebar)
        m_sidebar->setSelected(3);
}
...
void MainWindow::buildUi()
{
    ...
    auto *h1 = makeTitle(tr("VISION SIGHT"), 18, true, page);
...
{
    // Sidebar navigation (indices follow the menu order)
    if (m_sidebar) {
