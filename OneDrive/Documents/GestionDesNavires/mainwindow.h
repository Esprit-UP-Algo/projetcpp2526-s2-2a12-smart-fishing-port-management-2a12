...
private:
    ...
    QMenu *menuGestionNavires = nullptr;
    QActionGroup *menuGestionNaviresGroup = nullptr;
    QAction *actionNaviresAffichage = nullptr;
    QAction *actionNaviresStatistique = nullptr;
    QAction *actionNaviresAvancees = nullptr;
