...
public:
    ...
    bool createConnect(); // Méthode pour créer la connexion (valeurs par défaut)
    bool createConnect(const QString &dsn, const QString &user, const QString &password, QString *errorMessage = nullptr);
