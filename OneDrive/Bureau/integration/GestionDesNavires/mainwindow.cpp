...
// QCoreApplication et QProcess supprimés : modules externes désactivés
    ...
    , nextId(1)
{
    ...
    connect(ui->btnGestionNavires, &QPushButton::clicked, this, &MainWindow::onToggleNaviresMenu);
    connect(ui->btnNaviresAffichage, &QPushButton::clicked, this, &MainWindow::onNaviresAffichage);
    connect(ui->btnNaviresStatistique, &QPushButton::clicked, this, &MainWindow::onNaviresStatistique);
    connect(ui->btnNaviresAvancees, &QPushButton::clicked, this, &MainWindow::onNaviresAvancees);
