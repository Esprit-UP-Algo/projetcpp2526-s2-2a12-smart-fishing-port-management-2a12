...
QuaiConnection &QuaiConnection::createInstance()
{
    static QuaiConnection instance;
    return instance;
}

QuaiConnection::QuaiConnection()
...
bool QuaiConnection::createConnection()
{
...
void QuaiConnection::closeConnection()
{
    if (m_db.isOpen())
        m_db.close();
...
QSqlDatabase QuaiConnection::database() const
{
    return m_db;
}
